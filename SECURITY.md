...
The CI pipeline runs `scripts/scan-prompts.sh` on all skill prompt files (`SKILL.md`) to flag potentially dangerous patterns before merge. This is a best-effort control, not a guarantee.
